...
Exit codes:
  ...
  2 system error
  3 IAM / 403 — "fails loudly" behaviour is intentional.
"""
...
# the union of what register_skill writes and what skill-finder
...
_ATTR_DEFS: tuple[tuple[str, str, str], ...] = (
    (
        "agentic_skill",
        "Agentic skill",
        "True for skills consumable by the skill-finder runtime.",
    ),
    (
        "keywords",
        "Keywords",
